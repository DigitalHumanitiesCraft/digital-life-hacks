...
- [Windows PowerToys](https://github.com/microsoft/PowerToys) für erweiterte Fensterverwaltung
...
- **Windows:** Windows-Taste + V ([Anleitung](https://support.microsoft.com/windows/clipboard-history))  
- **Mac:** [Alfred](https://www.alfredapp.com/) oder ein anderer Clipboard-Manager

Zeigt den Verlauf deiner Zwischenablage an.

💡 **Pro-Tipp (OCR):** 
- Mit [Adobe Acrobat Reader](https://acrobat.adobe.com/de/de/acrobat/pdf-reader.html), [OneNote](https://www.onenote.com/) oder anderen Tools kannst du Text aus PDFs und Bildern extrahieren
- Auf dem Mac beherrscht [Preview](https://support.apple.com/guide/preview/) in einigen Versionen ebenfalls OCR
- Google Tools:
  - Google Lens im Chrome: Rechtsklick auf Bild → "Mit Google Lens suchen"
  - Google Drive: PDF hochladen → Rechtsklick → "Mit Google Docs öffnen" für automatische Texterkennung
  
Anschließend kannst du den erkannten Text direkt kopieren und in KI-Chats einfügen.
...
- **Mac:** CMD + SHIFT + 4  
- [ShareX](https://getsharex.com/) für erweiterte Screenshot-Funktionen
...
- [Windows PowerToys](https://github.com/microsoft/PowerToys) for enhanced window management
...
- **Windows:** Windows key + V ([Guide](https://support.microsoft.com/windows/clipboard-history))  
- **Mac:** Use [Alfred](https://www.alfredapp.com/) or another clipboard manager

Access your clipboard history.

💡 **Pro tip (OCR):** 
- Tools like [Adobe Acrobat Reader](https://acrobat.adobe.com/de/de/acrobat/pdf-reader.html), [OneNote](https://www.onenote.com/), or others can extract text from PDFs and images
- On Mac, [Preview](https://support.apple.com/guide/preview/) supports OCR in some versions
- Google tools:
  - Google Lens in Chrome: Right-click image → "Search image with Google Lens"
  - Google Drive: Upload PDF → Right-click → "Open with Google Docs" for automatic text recognition
  
You can then copy that text right into AI chats.
...
- **Mac:** CMD + SHIFT + 4  
- [ShareX](https://getsharex.com/) for advanced screenshot features
